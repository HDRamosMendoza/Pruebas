...
define([
  ...
  query, registry, LayerListView, NlsStrings, LayerInfos, PopupPortal) {
    ...
    var clazz = declare([BaseWidget], {
      ...
      startup: function() {
        ...
        this.map.getLayer('limites_peru_7938').infoTemplates = {
          0: { infoTemplate: PopupPortal.PopupTemplate_CentrosPoblados },
          2: { infoTemplate: PopupPortal.PopupTemplate_ViasVecinales },
          3: { infoTemplate: PopupPortal.PopupTemplate_ViasDepartamentales },
          4: { infoTemplate: PopupPortal.PopupTemplate_ViasNacionales },
          5: { infoTemplate: PopupPortal.PopupTemplate_ViaFerrea },
          6: { infoTemplate: PopupPortal.PopupTemplate_Departamento },
          7: { infoTemplate: PopupPortal.PopupTemplate_Distrito },
          8: { infoTemplate: PopupPortal.PopupTemplate_Provincia }
        };
