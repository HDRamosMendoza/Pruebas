...
define([
    ...
    './PopupPortalLimite',
    './PopupPortalDecretoVisor'
  ],
  function(BaseWidget, declare, lang, array, html, dom, on,
  query, registry, LayerListView, NlsStrings, LayerInfos, PopupPortalLimite, PopupPortalDecretoVisor) {
    ...
    var clazz = declare([BaseWidget], {
      ...
      startup: function() {
        ...
        // Visualiza las lista de capas
        console.log(this.map.getLayersVisibleAtScale());
        // Capas de Información Base
        this.map.getLayer('limites_peru_7938').infoTemplates = {
          0: { infoTemplate: PopupPortalLimite.PopupTemplate_CentrosPoblados },
          2: { infoTemplate: PopupPortalLimite.PopupTemplate_ViasVecinales },
          3: { infoTemplate: PopupPortalLimite.PopupTemplate_ViasDepartamentales },
          4: { infoTemplate: PopupPortalLimite.PopupTemplate_ViasNacionales },
          5: { infoTemplate: PopupPortalLimite.PopupTemplate_ViaFerrea },
          6: { infoTemplate: PopupPortalLimite.PopupTemplate_Departamento },
          7: { infoTemplate: PopupPortalLimite.PopupTemplate_Distrito },
          8: { infoTemplate: PopupPortalLimite.PopupTemplate_Provincia }
        };
        /*
        this.map.getLayer('proyectos_decreto_visor_7498').infoTemplates = {
          3: { infoTemplate: PopupPortalDecretoVisor.PopupTemplate_ActosPrevios },
        };*/

        //console.log(this.map.getLayer('VMVU_VISOR_DECRETO_DE_URGENCIA_9093'));
