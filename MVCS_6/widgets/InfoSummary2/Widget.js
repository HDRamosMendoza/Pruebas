  ...
  return declare([BaseWidget, _WidgetsInTemplateMixin], {
    ...
    _countProject: function _countProject() {
      ...
      try {
        ...
        /* Filtrado de capas */
        this.listLayer.forEach(function (element) {
          resultLayer = _this.map.getLayer(element);
        ...
        function (item) {
          ...
          try {
            ...
            for (var r = 0; r < featuresLength; r++) {
              ...
              tagHtml.push('<li class="list-group-item"                   data-objectId="' + featureAttributes[this.distrito.OBJECTID] + '"                   data-id="' + featureAttributes[this.distrito.IDDISTRITO] + '"                   data-name="distrito" data-limite="' + featureAttributes[this.distrito.NAME_DISTRITO] + '">                    &nbsp;' + featureAttributes[this.distrito.NAME_DEPARTAMENTO] + ',                    Provincia ' + featureAttributes[this.distrito.NAME_PROVINCIA] + ',                    Distrito ' + featureAttributes[this.distrito.NAME_DISTRITO] + '\n                  </li>');
            }
        ...
        function (item) {
          ...
          try {
            ...
            for (var i = 0; i < featuresLength; i++) {
              ...
              tagHtml.push('<li class="list-group-item"                   data-objectId="' + featureAttributes[this.departamento.OBJECTID] + '"                   data-id="' + featureAttributes[this.departamento.IDDEPARTAMENTO] + '"                   data-name="departamento" data-limite="' + featureAttributes[this.departamento.NAME_DEPARTAMENTO] + '">                  &nbsp; ' + featureAttributes[this.departamento.NAME_DEPARTAMENTO] + '                </li>');
            }
            this.ID_General.innerHTML += tagHtml.join("");
            this._tableResult(counter);
          } catch (error) {
